...
* **For Cursor:** Create a file at `.cursor/rules/puli-reviewer.md` and paste the content from [our rules template here]([https://drive.google.com/file/d/1AO_tMy-LJEh9b3c-hHl2GCV3bShFnzb6/view?usp=sharing)).
